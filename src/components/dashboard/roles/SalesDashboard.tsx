...
export function SalesDashboard() {
  ...
  return (
    <div className="space-y-5">
      ...
      >
        <div className="text-[12px] text-white/70">Today · {name}</div>
        <div className="mt-1 flex items-baseline gap-2">
          <IndianRupee className="h-5 w-5 text-white/80" />
          <span className="font-mono text-[36px] font-semibold leading-none">0</span>
        </div>
        <div className="mt-1 text-[12px] text-white/70">Today's revenue · आज की बिक्री</div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="mt-2 text-[16px] font-semibold">New order</div>
          <div className="text-[11px] text-white/75">नया ऑर्डर बनाएं</div>
        </Link>
        <Link
        ...
        >
          ...
          <div className="mt-2 text-[16px] font-semibold">My orders</div>
          <div className="text-[11px] text-white/75">मेरे ऑर्डर</div>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Link to="/app/products" className="flex items-center gap-2 rounded-xl bg-card p-3 text-[13px] font-medium shadow-[0_1px_3px_rgba(0,0,0,0.08)] hover:bg-muted/40">
          <ClipboardList className="h-4 w-4 text-primary" /> Catalog
        </Link>
      </div>

      <section>
        <h2 className="mb-2 px-1 text-[13px] font-semibold">Recent orders</h2>
        <div className="rounded-2xl bg-card p-5 text-center text-sm text-muted-foreground shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
          <Link to="/app/dispatch-orders" className="text-primary hover:underline">Open dispatch orders →</Link>
        </div>
      </section>
    </div>
  );
