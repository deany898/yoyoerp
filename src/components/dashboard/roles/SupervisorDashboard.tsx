  ...
  return (
    <div className="-mx-4 -mt-3 min-h-[calc(100vh-7rem)] bg-[#0B1733] px-4 pt-4 pb-6 md:-mx-6 md:-mt-6 md:px-6 md:pt-6">
      <div className="space-y-5 text-white">
        <div>
          <div className="text-[12px] text-white/60">{t("dash_supervisor_floor")}</div>
          <h1 className="mt-1 text-[22px] font-semibold">{t("dash_hello")} {name}</h1>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <DarkMetric label={t("dash_handoffs_waiting")} value={0} accent="#F97316" />
        </div>
        ...
        >
          <div className="text-[11px] font-semibold uppercase tracking-wider text-white/60">{t("dash_my_active_run")}</div>
          <div className="mt-2 text-[18px] font-semibold">{t("dash_no_active_run")}</div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            ...
            >
              <Plus className="h-4 w-4" /> {t("btn_log_output")}
            </Link>
            <Link
              to="/app/wip"
            ...
            >
              <ArrowLeftRight className="h-4 w-4" /> {t("btn_handoff")}
            </Link>
          </div>
        </div>
        ...
        <section>
          <div className="mb-2 flex items-center justify-between">
            <h2 className="text-[13px] font-semibold">{t("dash_handoffs_waiting")}</h2>
            <Link to="/app/wip" className="text-[11px] font-medium text-[#38BDF8] hover:underline">{t("dash_view_all")}</Link>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Link to="/app/manufacturing" className="rounded-xl bg-white/5 p-3 text-center text-[12px] font-medium text-white hover:bg-white/10">
            <Factory className="mx-auto mb-1 h-4 w-4" /> {t("dash_my_mos")}
          </Link>
          <Link to="/app/manufacturing" className="rounded-xl bg-white/5 p-3 text-center text-[12px] font-medium text-white hover:bg-white/10">
            <ListChecks className="mx-auto mb-1 h-4 w-4" /> {t("dash_floor")}
          </Link>
        </div>
      </div>
    </div>
