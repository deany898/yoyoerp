...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Yoyo" },
      { name: "format-detection", content: "telephone=no" },
      { title: "Yoyo" },
      { name: "description", content: "Yoyo unifies inventory, suppliers, purchase orders and AI reorder intelligence in one mobile-first industrial platform." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Yoyo" },
      { property: "og:description", content: "Yoyo unifies inventory, suppliers, purchase orders and AI reorder intelligence in one mobile-first industrial platform." },
      ...
      { name: "twitter:title", content: "Yoyo" },
      { name: "twitter:description", content: "Yoyo unifies inventory, suppliers, purchase orders and AI reorder intelligence in one mobile-first industrial platform." },
    ],
    links: [
      {
        rel: "stylesheet",
